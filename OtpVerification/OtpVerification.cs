...
{
    public class OtpVerifications : IOtpVerification
    {
        ...
        public OtpVerifications(IDataProtectionProvider dataProtection, IHttpContextAccessor httpContext,
        ...
        {
            return Generate(id, options, out _);
        }
